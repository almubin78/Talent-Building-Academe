    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 px-4">
      ...
      <div className="bg-red-100 relative w-full max-w-md rounded-2xl  p-6 shadow-2xl animate-in fade-in zoom-in duration-300">
        ...
        <button
          ...
          className="absolute top-3 right-3 rounded-full p-1 hover:bg-gray-200 transition text-red-500 border border-red-500"
        >
          <X size={22} />
        </button>
        ...
        <div className="text-center">
          ...
          <p className="mt-2 text-gray-600">{paragraph}</p> <br />
